...
public interface TestPortType {
     ...
     * @throws Error
     */
    @WebMethod(operationName = "add_simple", action = "http://example.com/add_simple")
    @WebResult(name = "result", targetNamespace = "http://example.com/types/")
    @RequestWrapper(localName = "add_simple", targetNamespace = "http://example.com/types/", className = "com.example.types.AddSimple")
    @ResponseWrapper(localName = "add_simple_result", targetNamespace = "http://example.com/types/", className = "com.example.types.AddSimpleResult")
